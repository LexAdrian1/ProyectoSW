...
class PersonData {
	...
	public function add_client(){
		$sql = "insert into person (name,lastname,address1,email1,phone1,kind,created_at,cedula) ";
		$sql .= "value (\"$this->name\",\"$this->lastname\",\"$this->address1\",\"$this->email1\",\"$this->phone1\",1,$this->created_at,\"$this->cedula\")";
		Executor::doit($sql);
	}
